...
TASK_BATTERY: Final = (
    {
        ...
        "key": "silence",
        "title": "Room silence",
        "instruction": "Silence, please. Do not speak, and try not to move. We are recording how quiet the room is for 3 seconds.",
        "stems": ("silence",),
        "takes_per_stem": 1,
        "stop": "auto",
        "target_s": 3.0,
    ...
    },
    {
        ...
        "instruction": "A beep will play from the speaker. Do not speak. This checks the equipment has not changed since yesterday.",
    ...
    },
    {
        ...
        "key": "sustained_a",
        "title": "Sustained /a/",
        "instruction": "Say “ah” — the vowel in FATHER — and hold it steady for about 5 seconds. Use your normal speaking pitch and normal loudness. Do not sing, and do not go high or low.",
        "stems": ("sustained_a",),
        "takes_per_stem": 3,
        "stop": "manual",
        "target_s": 5.0,
    ...
    },
    {
        ...
        "key": "sustained_i",
        "title": "Sustained /i/",
        "instruction": "Say “ee” — the vowel in SEE — and hold it steady for about 5 seconds. Same normal pitch and loudness as before.",
        "stems": ("sustained_i",),
        "takes_per_stem": 1,
        "stop": "manual",
        "target_s": 5.0,
    ...
    },
    {
        ...
        "instruction": "Say “pa pa pa pa” (like the start of PARK) as QUIETLY as you possibly can — the softest sound that is still your voice, almost a whisper but not a whisper. Quietness matters more than how many.",
        "stems": ("soft_pa",),
        "takes_per_stem": 1,
        "stop": "manual",
    ...
    },
    {
        ...
        "instruction": "Read your passage out loud in your own language, at your normal speaking pace and loudness, for about 30 seconds. The same passage every session.",
    ...
    },
    {
        ...
        "key": "pataka",
        "title": "/pa-ta-ka/",
        "instruction": "Repeat “pa-ta-ka pa-ta-ka pa-ta-ka” over and over, as FAST and as EVEN as you can, for about 8 seconds. Keep going until told to stop. Speed and evenness both matter.",
        "stems": ("pataka",),
        "takes_per_stem": 1,
        "stop": "manual",
        "target_s": 8.0,
    ...
    },
    {
        ...
        "instruction": "Take a deep breath, then make a long “sssss” (like a hissing snake) for as long as you can, until your breath runs out. Then breathe, and do the same with “zzzzz” (like a buzzing bee).",
    ...
    },
    {
        ...
        "instruction": "Take the deepest breath you can, then say “ah” (as in FATHER) and hold it for AS LONG AS YOU POSSIBLY CAN, until you run out of breath. Normal pitch and loudness — this is about duration, not volume.",
        "stems": ("mpt",),
        "takes_per_stem": 2,
        "stop": "manual",
        "target_s": None,  # maximum duration — no ceiling
